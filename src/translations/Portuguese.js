...
export const PORTUGUESE_TRANSLATION: TRANSLATION_OBJ = {
  ...
  SendPage: {
    ...
    confirmSend: 'Eu quero enviar estes BZC',
    ...
    bitzecAmount: 'Quantia deve ser maior que 0.',
    notEnoughZEN: 'Não existe quantidade suficiente de BZC confirmadas na conta para fazer essa transação.',
  ...
  PinPage: {
    ...
    newPinPageTitle: 'Configuração da carteira de BZC',
    verifyPinPageTitle: 'Verificação do Pin da Carteira BZC',
    setupNewPin: 'Configure um novo PIN de 4 dígitos',
    reenterPin: 'Confirme seu PIN',
    pinsNotSimilar: 'PINs digitados não conferem',
    invalidPin: 'PIN Inválido',
    enterYourPin: 'Digite seu PIN de 4 dígitos'
  },
  ContactsPage: {
    contacts: 'Contacts',
    contactsName: 'Name',
