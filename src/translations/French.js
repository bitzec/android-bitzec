...
export const FRENCH_TRANSLATION: TRANSLATION_OBJ = {
  ...
  SendPage: {
    ...
    confirmSend: 'Je veux envoyer ces BZC',
    ...
    bitzecAmount: 'Le montant doit être supérieur à 0.',
    notEnoughZEN: 'Pas assez de BZC confirmés sur le compte pour effectuer cette transaction.',
  ...
  PinPage: {
    ...
    newPinPageTitle: 'Configuration du Porte-Monnaie BZC',
    verifyPinPageTitle: 'Vérification du code PIN du Porte-Monnaie BZC',
